        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex items-center">
              ...
              <button className="ml-4 px-6 py-4 bg-white/20 backdrop-blur-sm border border-white/20 rounded-xl hover:bg-white/30 transition-colors flex items-center">
          ...
          <div className="lg:w-1/4">
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24">
              <h3 className="text-lg font-semibold text-gray-900 mb-6">
                {translations.filterAndSort || 'Filter & Sort'}
              </h3>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      { value: 'featured', label: translations.featured || 'Featured' },
                      { value: 'rating', label: translations.rating || 'Rating' },
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      { value: 'all', label: translations.allPrices || 'All Prices' },
                      { value: '$', label: `$ (${translations.budget || 'Budget'})` },
                      { value: '$$', label: `$$ (${translations.moderate || 'Moderate'})` },
                      { value: '$$$', label: `$$$ (${translations.expensive || 'Expensive'})` },
                      { value: '$$$$', label: `$$$$ (${translations.luxury || 'Luxury'})` }
                    ].map((price) => (
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-3">
                    {translations.minimumRating || 'Minimum Rating'}
                  </label>
                  <div className="space-y-2">
                    {[
                      { value: 'all', label: translations.allRatings || 'All Ratings' },
                      { value: '5', label: translations.starsAndAbove?.replace('{rating}', '5') || '5 ★ & above' },
                      { value: '4', label: translations.starsAndAbove?.replace('{rating}', '4') || '4 ★ & above' },
                      { value: '3', label: translations.starsAndAbove?.replace('{rating}', '3') || '3 ★ & above' }
                    ].map((rating) => (
                      <label key={rating.value} className="flex items-center cursor-pointer">
                        ...
                        <span className="flex items-center">
                          {rating.value === 'all' ? rating.label : (
                            <>
                              {Array.from({length: parseInt(rating.value)}).map((_, i) => (
                                <FaStar key={i} className="text-yellow-400 ml-0.5" />
                              ))}
              ...
              <button
                ...
                className="w-full mt-8 py-3 border-2 border-gray-200 text-gray-700 rounded-xl font-medium hover:bg-gray-50 transition-colors"
              >
                {translations.clearAllFilters || 'Clear All Filters'}
              </button>
            </div>
          </div>
            ...
            <div className="flex justify-between items-center mb-8">
              ...
              <div className="flex items-center text-gray-600">
                ...
                <span className="font-medium">
                  {translations.sortedBy?.replace('{sort}', filters.sortBy.replace('-', ' ')) || 
            ...
            {filteredItems.length === 0 ? (
              <div className="text-center py-20">
                ...
                <button
                  onClick={() => {
                    setSearch('');
                    setFilters({ price: 'all', rating: 'all', sortBy: 'featured' });
                  }}
